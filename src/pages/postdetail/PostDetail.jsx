  ...
  return (
    <>
      ...
      <link
        rel="preload"
        as="image"
        href="https://images.pexels.com/photos/3532554/pexels-photo-3532554.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
      />
      <link
        rel="preload"
        as="image"
        href="https://images.pexels.com/photos/18148936/pexels-photo-18148936.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
      />
      <link
        rel="preload"
        as="image"
        href="https://images.pexels.com/photos/1092422/pexels-photo-1092422.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
      />
      <link
        rel="preload"
        as="image"
        href="https://images.pexels.com/photos/1114619/pexels-photo-1114619.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
      />
      <link
        rel="preload"
        as="image"
        href="https://images.pexels.com/photos/998716/pexels-photo-998716.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
      />
      <link
        rel="preload"
        as="image"
        href="https://images.pexels.com/photos/998714/pexels-photo-998714.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
      />
      <link
        rel="preload"
        as="image"
        href="https://images.pexels.com/photos/909489/pexels-photo-909489.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
      />
      <link
        rel="preload"
        as="image"
        href="https://images.pexels.com/photos/909487/pexels-photo-909487.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
      />
      <link
        rel="preload"
        as="image"
        href="https://images.pexels.com/photos/909483/pexels-photo-909483.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
      />
            ...
            <div className="relative border-b border-white last:border-none">
              <div className="flex p-4 text-white">
                ...
                <div className="pl-4 pt-1">
                  ...
                  <p className="mb-4 text-sm sm:text-base">
                    Absolutely love your commitment to clean energy, Solar
                    Flare! Keep up the great work! 💚♻️
                  </p>
                  <div className="mb-4 grid grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))] gap-4">
                    <img
            ...
            <div className="relative border-b border-white last:border-none">
              <div className="flex p-4 text-white">
                ...
                <div className="pl-4 pt-1">
                  ...
                  <p className="mb-4 text-sm sm:text-base">
                    Your efforts are helping us move towards a sustainable
                    future. Kudos, Solar Flare! 🌞🌱
                  </p>
                  <div className="mb-4 grid grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))] gap-4">
                    <img
              ...
              <div className="flex p-4 text-white">
                ...
                <div className="pl-4 pt-1">
                  ...
                  <p className="mb-4 text-sm sm:text-base">
                    Every ray of sunshine counts! Have you considered
                    integrating solar in urban spaces, Solar Flare?
                  </p>
                  <div className="flex gap-x-4">
                    <button
                      className="group inline-flex items-center gap-x-1 outline-none after:content-[attr(data-like-count)] focus:after:content-[attr(data-like-count-alt)] text-[#ae7aff] focus:text-inherit"
              ...
              <div className="flex p-4 text-white">
                ...
                <div className="pl-4 pt-1">
                  ...
                  <p className="mb-4 text-sm sm:text-base">
                    Your dedication to solar energy is inspiring, Solar Flare!
            ...
            <div className="relative border-b border-white last:border-none">
              <div className="flex p-4 text-white">
                ...
                <div className="pl-4 pt-1">
                  ...
                  <p className="mb-4 text-sm sm:text-base">
                    You&#x27;re doing incredible work for the environment, Solar
                    Flare. 💪🌿 Let&#x27;s all go solar!
                  </p>
                  <div className="flex gap-x-4">
                    <button
                      className="group inline-flex items-center gap-x-1 outline-none after:content-[attr(data-like-count)] focus:after:content-[attr(data-like-count-alt)] hover:text-[#ae7aff] focus:text-[#ae7aff]"
